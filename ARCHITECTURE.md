...
graph LR
    ...
    style B fill:#e1f5ff,stroke:#0277bd,color:#000
...
graph TD
    ...
    style C1 fill:#ffe0b2,stroke:#e64a19,color:#000
    style C2 fill:#f8bbd0,stroke:#c2185b,color:#000
```
...
graph TD
    ...
    style H fill:#ff9800,stroke:#ef6c00,stroke-width:2px
...
graph TD
    ...
    style A fill:#2196f3,stroke:#1565c0,stroke-width:2px,color:#fff
    style C fill:#4caf50,stroke:#2e7d32,stroke-width:2px,color:#fff
    style D2 fill:#f44336,stroke:#c62828,stroke-width:2px,color:#fff
    style D4 fill:#f44336,stroke:#c62828,stroke-width:2px,color:#fff
...
graph TD
    ...
    style B fill:#ff9800,stroke:#ef6c00,stroke-width:2px
